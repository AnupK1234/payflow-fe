...
//   {
//     path: '',
//     loadComponent: () => import('./layout/bank-admin-layout.component').then(m => m.BankAdminLayoutComponent),
//     children: [
//       {
//         path: '',
...
//       {
//         path: 'organizations',
//         loadComponent: () => import('./pages/organizations/organizations-list.component').then(m => m.OrganizationsListComponent),
